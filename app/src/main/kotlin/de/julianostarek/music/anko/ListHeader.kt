...
class ListHeader(itemView: View, ui: UI, activity: AppCompatActivity) : UniversalViewHolder<Nothing>(itemView, ui, activity) {
    ...
    class UI : UniversalUI() {
        ...
        override fun createView(ui: AnkoContext<ViewGroup>) = with(ui) {
            textView {
                title = this
                layoutParams = ViewGroup.LayoutParams(wrapContent, dip(48))
